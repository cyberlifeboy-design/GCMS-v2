...
export const DEFAULT_TEMPLATES: DefaultTemplate[] = [
    ...
    {
        key: 'venue_admin_assigned',
        name: 'Venue Admin (VLM) Assigned',
        category: 'Accounts',
        description: 'Sent when a SuperAdmin assigns someone as a venue\'s Admin — whether that creates a new account or promotes an existing one.',
        variables: ['name', 'venueName', 'loginUrl'],
        emailEnabled: true,
        emailSubject: "You've been assigned as Venue Logistics Manager for {{venueName}}",
        emailBody:
            "Hello {{name}},\n\nGCMS has assigned you as the Venue Logistics Manager (VLM) for {{venueName}}. As VLM, you can manage this venue's fleet, users, and requests.\n\nSign in with your SC/LOC Microsoft account at {{loginUrl}} to get started.\n\nThank you,\nGCMS",
        pushEnabled: false,
        pushTitle: null,
        pushMessage: null,
    },
    {
        ...
        name: 'Access Request Received (to Admin)',
        category: 'Access Requests',
        description: "Sent to a venue's Admin(s) and SuperAdmin when someone submits a self-service access request for that venue.",
        variables: ['requesterName', 'departmentName', 'stadiumName', 'reviewUrl'],
        emailEnabled: true,
        emailSubject: 'New access request — {{requesterName}} at {{stadiumName}}',
        emailBody:
            'Hello,\n\n{{requesterName}} has requested access to {{stadiumName}} ({{departmentName}}).\n\nReview it here: {{reviewUrl}}\n\nThank you,\nGCMS',
        pushEnabled: false,
        pushTitle: null,
        pushMessage: null,
    },
    {
        ...
        category: 'Access Requests',
        description: 'Sent to the requester when their access request is approved.',
        variables: ['name', 'reviewNotesLine'],
        emailEnabled: true,
        emailSubject: 'Your GCMS access request has been approved',
        emailBody:
    ...
    },
    {
        ...
        category: 'Access Requests',
        description: 'Sent to the requester when their access request is rejected.',
        variables: ['name', 'reviewNotesLine'],
        emailEnabled: true,
        emailSubject: 'Your GCMS access request has been rejected',
